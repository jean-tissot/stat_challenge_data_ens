...
X_train, X_test, y_train, y_test, prop_HF = datatreat_A1(X, y, train_size=0.8, Shuffle=True, preprocess="None", ratio="50/50", balancing_method="SMOTE")
...
save_results(id, 'datatreat_A1', 'cnn_2', epochs, batch_size, accuracy, roc, f1_macro, f1_wei, validation_split)
